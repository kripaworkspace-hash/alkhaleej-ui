import { EVENT_STATUS, packingEventLog } from '../data/mockPackingBay'

/** Reportable packing-belt events: fully stopped, or moving without sacks. */
function EventLog() {
  return (
    <section className="flex flex-col rounded-2xl border border-white/80 bg-white/90 px-5 py-4 shadow-[0_1px_2px_rgba(15,23,42,0.06),0_8px_16px_-6px_rgba(15,23,42,0.12),0_24px_48px_-12px_rgba(15,23,42,0.22)] backdrop-blur-md">
      <h2 className="text-sm font-bold text-slate-900">Packing Section — Event Log</h2>
      <p className="mt-1 text-xs text-slate-500">
        Reportable events for packing belts only: belt stopped completely, or belt moving without sacks.
      </p>
